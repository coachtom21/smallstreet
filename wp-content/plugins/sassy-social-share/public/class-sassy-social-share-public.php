...
class Sassy_Social_Share_Public {
	...
	public function mastodon_share_amp() {
		...
		if ( isset( $_GET['heateor_mastodon_share'] ) && trim( $_GET['heateor_mastodon_share'] ) ) {
			...
			<div id="heateor_sss_sharing_more_providers" style="height: auto;"><button id="heateor_sss_mastodon_popup_close" class="close-button separated"><img src="<?php echo plugins_url( '../images/close.png', __FILE__ ) ?>"></button><div id="heateor_sss_sharing_more_content"><div class="all-services" style="height:auto"><div class="filter"><center><?php _e( 'Your Mastodon Instance', 'sassy-social-share' ); ?></center><input type="text" id="heateor_sss_mastodon_instance" placeholder="https://mastodon.social" class="search"><center><input type="button" class="heateor_sss_mastodon_popup_button" value="<?php _e( 'Submit', 'sassy-social-share' ); ?>" onclick="var heateorMastodonInstance = document.getElementById('heateor_sss_mastodon_instance').value.trim(), heateorMastodonAnchor = '<?php echo strpos( urldecode( $_GET['heateor_mastodon_share'] ), 'https://mastodon.social/share?text=' ) === 0 ? esc_js( esc_url( urldecode( trim( $_GET['heateor_mastodon_share'] ) ) ) ) : '' ?>'; heateorMastShareURL = heateorMastodonInstance ? heateorMastodonAnchor.replace('https://mastodon.social', heateorMastodonInstance) : heateorMastodonAnchor;location.href = heateorMastShareURL;"></center></div></div><div class="footer-panel"></div></div></div><div id="heateor_sss_mastodon_popup_bg"></div>
			<?php
			exit();
		}
