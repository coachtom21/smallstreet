...
<div data-key="<?php echo $cart_item_key ?>" class="<?php echo implode(' ', $productClasses) ?>">
	...
	<div class="xoo-wsc-sum-col">
		...
		<?php if ($showSalesCount && $_product->get_total_sales() > 0): ?>
			<div class="xoo-wsc-sm-sales">
				<?php echo $_product->get_total_sales() . '+ ' ?>
				<?php _e('shoppers have bought this', 'side-cart-woocommerce'); ?>
			</div>
		<?php endif; ?>
			...
			<div class="xoo-wsc-sm-left">
				...
				<?php if (!$updateQty): ?>
					...
					<div class="xoo-wsc-qty-price">
						...
						<?php else: ?>
							<span><?php _e('Qty:', 'side-cart-woocommerce') ?></span>
