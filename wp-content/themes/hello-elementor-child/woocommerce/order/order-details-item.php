...
<tr>
	<td class="woocommerce-table__product-xp product-xp"><strong>XP Earned</strong></td>
	<td class="woocommerce-table__product-xp product-xp">
		<?php
		if (isset($xp_earned) && $xp_earned > 0) {
			echo number_format($xp_earned) . ' XP';
		} else {
			echo '—';
		}
		?>
